...
#y = Número de latas
import math
tamanho = float(input("Área em m²: "))
tinta_litros = tamanho/6
x = math.ceil(tinta_litros/4)
y = math.ceil(tinta_litros/18)

if x <= 3:
    
    if x == 1:
        print ("Comprar 1 galão de tinta")

    if x > 1:
        print("Comprar", x, "galões de tinta")

else:
    
    if y == 1:
        print ("Comprar 1 lata de tinta")
